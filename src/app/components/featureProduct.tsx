      ...
      <div className="flex flex-col items-center justify-center text-center mt-28 mb-7 overflow-x-hidden">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-1 mt-6 w-full">
          {products.map((product) => (
            <ProductCard {...product} key={product.slug || product.title} />
          ))}
        </div>
        ...
        <div className="flex items-center justify-between mt-16 flex-col md:flex-row">
          ...
          {/* TEXT AREA */}
          <div className="text-center md:text-left w-full md:w-auto mt-6 md:mt-0 leading-10">
            ...
            <div className="flex gap-5 justify-center md:justify-start">
              <button
                className="text-white w-[145px] h-[50px] text-[14px] font-bold rounded-md bg-[#23A6F0] hover:bg-transparent text-center hover:text-blue-500 md:bg-[#2DC071] md:hover:bg-transparent md:hover:text-[#2DC071]"
              >
                Buy Now
              </button>
              <button
                className="text-[#23A6F0] text-[14px] font-bold w-[156px] h-[50px] text-center rounded-md border-2 border-[#23A6F0] hover:bg-[#23A6F0] hover:text-white md:border-[#2DC071] md:text-[#2DC071] md:hover:bg-transparent md:hover:bg-green-500"
              >
                Read More
              </button>
            </div>
