...
const Office = ()=>{
    const cards=[
        ...
        {
        icon:(
        <FiMapPin className="text-[#23A6F0] text-[48px] w-[72px] 
        h-[72px]"/>   
            ),
        ...
        button:"View on Map",   
           ...
           {
            icon:(
            <FiMail className="text-[#23A6F0] text-[48px] w-[72px] h-[72px]"/>   
                ),
...
? "bg-transparent border border-[#23A6F0] text-[#23A6F0] hover:bg-[#23A6F0] hover:text-white":"bg-transparent border border-[#23A6F0] text-[#23A6F0] hover:text-white"} font-bold py-4 px-6 rounded-full transition`}>
{card.button}
</button>
</div>
))}
